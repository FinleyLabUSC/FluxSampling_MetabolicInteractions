...
parfor i = 1:size(info, 1)
    ...
    % If you prefer to use polytope sampler
%     initSampler
%     P = struct;
%     P.lb = pairedModel.lb;
%     P.ub = pairedModel.ub;
...
%     Paired_samples = Model_samplingResult.samples;
    ...
    [~, Paired_samples] =  sampleCbModel(pairedModel, [], 'RHMC', Samplingoptions);
...
% RHMC
    [~, Single1_samples] =  sampleCbModel(pairedModel, [], 'RHMC', Samplingoptions);
...
% RHMC
    [~, Single2_samples] =  sampleCbModel(pairedModel, [], 'RHMC', Samplingoptions);
